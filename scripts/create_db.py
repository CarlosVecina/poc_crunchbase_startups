...
def create_tables_if_not_exist():
    ...
    try:
        ...
        cur.executescript("""
            ...
            """)
        cur.executescript("""
            CREATE UNIQUE INDEX organizations_idx ON organizations(name, inserted_at);
            """)
        ...
        cur.executescript("""
            ...
            """)
        cur.executescript("""
            CREATE UNIQUE INDEX organization_people_idx ON organization_people(full_name, inserted_at, startup_name);
            """)
        ...
        cur.executescript("""
            ...
            """)
        cur.executescript("""
            CREATE UNIQUE INDEX investment_firms_idx ON investment_firms(name, inserted_at);
            """)
        ...
        cur.executescript("""
            ...
            """)
        cur.executescript("""
            CREATE UNIQUE INDEX rounds_idx ON rounds(round_name, inserted_at);
            """)
